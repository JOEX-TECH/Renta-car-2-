...
export default function Services() {
  ...
  return (
    <section className="py-20 md:py-28 px-6 md:px-12 max-w-[1400px] mx-auto" id="servicios">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {services.map((s, i) => (
          <div key={i} className="bg-white/[0.02] border border-white/5 p-10 rounded-lg transition-all duration-500 hover:bg-white/[0.04] hover:border-primary/30">
