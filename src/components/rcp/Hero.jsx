...
export default function Hero() {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden flex flex-col justify-center items-center text-center bg-black">
      ...
      <div className="relative z-[3] max-w-[1100px] px-6 mt-10">
        ...
        <a href="#flota" className="inline-block px-8 py-4 text-[0.8rem] font-bold uppercase tracking-[2px] text-white border border-white rounded hover:bg-white hover:text-black transition-all duration-500">
          {t.hero.btn}
        </a>
      </div>
    </section>
